#ifndef AliAnalysisTaskEMCALTimeCalibPAR_h
#define AliAnalysisTaskEMCALTimeCalibPAR_h

//_________________________________________________________________________
/// \class AliAnalysisTaskEMCALTimeCalibPAR
...
class AliAnalysisTaskEMCALTimeCalibPAR : public AliAnalysisTaskSE 
{
 public:
   ...
   AliAnalysisTaskEMCALTimeCalibPAR() : AliAnalysisTaskSE(),
    fRunNumber(-1),
    //    fTOFmaker(0),
    fOutputList(0),
    fgeom(0),
  ...
  AliAnalysisTaskEMCALTimeCalibPAR(const char *name);
  virtual ~AliAnalysisTaskEMCALTimeCalibPAR() { ; }
...
//  AliTOFT0maker *fTOFmaker;   //->
  ...
  AliAnalysisTaskEMCALTimeCalibPAR(           const AliAnalysisTaskEMCALTimeCalibPAR&);
  
  /// Assignment operator not implemented.
  AliAnalysisTaskEMCALTimeCalibPAR& operator=(const AliAnalysisTaskEMCALTimeCalibPAR&); 
  
/// \cond CLASSIMP
  ClassDef(AliAnalysisTaskEMCALTimeCalibPAR, 5) ;
/// \endcond
};

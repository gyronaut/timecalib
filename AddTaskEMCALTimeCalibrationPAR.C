...
AliAnalysisTaskEMCALTimeCalibPAR* AddTaskEMCALTimeCalibrationPAR(TString  outputFile = "", // timeResults.root
                                 ...
                                 TString  PARFileName = "")
{
  ...
  if (!mgr) 
  {
    ::Error("AddTaskEMCALTimeCalibrationPAR", "No analysis manager to connect to.");
    return NULL;
  }  
  ...
  {
    ::Error("AddTaskEMCALTimeCalibrationPAR", "This task requires an input event handler");
    return NULL;
  }
    
  AliAnalysisTaskEMCALTimeCalibPAR *taskmbemcal = new AliAnalysisTaskEMCALTimeCalibPAR("TimeCalibTask");
